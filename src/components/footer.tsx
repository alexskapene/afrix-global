...
export default function Footer() {
  return (
    <footer className="w-full bg-afrix-dark text-white py-10 px-5 flex flex-col items-center">
      <div className="w-full max-w-300 flex flex-col sm:flex-row justify-between flex-wrap gap-10 mb-8">
        ...
        <div className="flex-1 min-w-55">
          ...
          <p className="text-white/80 text-sm leading-relaxed mb-4">
            Afrix Global propose des formations completes dans le domaine du
            numerique pour booster votre carriere.
          </p>
          <div className="flex gap-4">
            <Link
              href="#"
              aria-label="Facebook"
              className="text-afrix-blue hover:scale-110 transition-transform"
            >
        ...
        <div className="flex-1 min-w-55">
          ...
          <div className="space-y-3 text-white/80 text-sm">
            <p className="flex items-start gap-2">
              ...
              286, Avenue de Musée, Commune de Karisimbi, Ville de Goma
            </p>
