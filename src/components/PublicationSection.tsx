...
const publications = [
  {
    ...
    description: "Une courte description de la publication pour donner envie de lire.",
  },
  {
...
export default function PublicationSection() {
    ...
    >
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white text-center mb-10">
        NOS RECENTES <span className="text-[#4285f4]">PUBLICATIONS</span>
      </h2>

      <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-6 w-[90%] max-w-[1200px]">
        {publications.map((pub) => (
          ...
          >
            ...
            <CardContent className="p-5 flex flex-col gap-3">
              ...
              <p className="text-white text-base leading-relaxed">{pub.description}</p>
              <Button
                variant="outline"
